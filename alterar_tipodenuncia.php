...
<html lang="pt-BR">
    ...
    <div class="container">   
      ...
      <div class="row text-center">
        ...
        <?php
          ...
          $iddTipoDenuncia = $_GET['idTipoDenuncia'] ?? '';

          $sql = "SELECT * FROM tipo_denuncia WHERE idTipoDenuncia = $iddTipoDenuncia";
  ...
  <div class="container">
    <div class="row">   
      <div class="col-10">
        <h3 class="p-5 text-muted">Alterar Tipo de Denúncia</h3>
      </div>
      <div class="col-2 p-5">
        <a href="crud_tipodenuncia.php" class="btn btn-dark">Retornar</a>
      </div>
    </div>
      <form class="p-3 mt-4" action="editar_tipodenuncia_scripts.php" method="POST" >
      <div class="form-row">
        <div class="form-group col-md-6 p-3">
          <label class="form-label text-muted" for="desTipoDenuncia">Descrição/Nome:</label>
          <input type="text" class="form-control text-muted" name="desTipoDenuncia" required value="<?php echo $linha['desTipoDenuncia']; ?>">
        </div>
      </div>
        <div class="row">
          <div class="col-6 text-center mt-3">
            <button type="submit" class="btn btn-dark mx-3 mt-3">Alterar Tipo de Denúncia</button>
            <input type="hidden" name="iddTipoDenuncia" value="<?php echo $linha['idTipoDenuncia']; ?>">
          </div>
        </div>
    </form>
  </div>
