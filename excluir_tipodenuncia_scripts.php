    ...
    <div class="container">   
      ...
      <div class="row text-center">
        ...
        <?php
          ...
          $iddTipoDenuncia = $_POST['iddTipoDenuncia'];
          $desTipoDenuncia = $_POST['desTipoDenuncia'];
         
          $sql = "DELETE from `tipo_denuncia` WHERE idTipoDenuncia = $iddTipoDenuncia";

          if(mysqli_query($conn, $sql)){
            mensagem("Exclusão feita com sucesso!", 'success');
