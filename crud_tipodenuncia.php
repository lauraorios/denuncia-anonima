...
<html lang="pt-BR">
  ...
  <nav class="navbar mb-4 navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
	  ...
	  $sql = "SELECT * FROM tipo_denuncia WHERE desTipoDenuncia LIKE '%$busca%'";
  	...
  	<div class="container">
  		<div class="row mb-4">
  			<div class="col-11">
  		<form class="form-inline" action="crud_tipodenuncia.php" method="POST">
			
			<input class="form-control" type="search" name="pesquisa" placeholder="Procurar Tipo de Denúncia" aria-label = "Search" autofocus>
			</div>
			<div class="col-1">
		    ...
		    <tbody>
		    	<?php
		    			  while ($linha = mysqli_fetch_assoc($dados)) {
  						  	  $idTipoDenuncia = $linha['idTipoDenuncia'];
  						  	  $desTipoDenuncia = $linha['desTipoDenuncia'];
					    
					          echo "  <tr>
								        <th scope='row'>$idTipoDenuncia</th>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
								        <td>$desTipoDenuncia</td>
								        <td class='text-end'>
								        	<a href = 'alterar_tipodenuncia.php?idTipoDenuncia=$idTipoDenuncia' class = 'p-2 btn btn-dark btn-sm'>Alterar</a>
								        	<a href = '#' class = 'p-2 btn btn-dark btn-sm' data-bs-toggle='modal' data-bs-target='#confirmarexclusao'
                          onclick=" . '"' ."pegar_dados($idTipoDenuncia, '$desTipoDenuncia')" .'"'.">Excluir</a>
								        </td>
								      </tr>";
						  }
		    	?>
  ...
  <!-- Modal -->
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="excluir_tipodenuncia_scripts.php" method="POST">
              <p>Confirmar exclusão de <b id="nome_tipodenuncia"></b> ?</p>
              <b id="nome_tipodenuncia"></b>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Não</button>
              <input type="hidden" name="desTipoDenuncia" id="desTipoDenuncia1">
              <input type="hidden" name="iddTipoDenuncia" id="identD">
    ...
    <script type="text/javascript">
      function pegar_dados(iddTipoDenuncia, desTipoDenuncia) {
        document.getElementById('nome_tipodenuncia').innerHTML = desTipoDenuncia;
        document.getElementById('desTipoDenuncia1').innerHTML = desTipoDenuncia;
        document.getElementById('identD').value = iddTipoDenuncia;
      }
    </script>
